<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($first_name) OR empty($subject) OR empty($phone) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            echo "Completa el folmulario e intenta otra vez porfavor.";
        ...
        $recipient = "apmedicina26@gmail.com";

        // Set the email subject.

        $subject = "APMedicina - Correo de $first_name";
        ...
        $email_headers .= 'From:' . $first_name . ' ' . 'apmedicina26@gmail.com' . "\r\n";
        ...
        if (mail($recipient, $subject, $email_content, $email_headers)) {
            ...
            echo "Muchas Gracias! Su mensaje ha sido enviado.";
            ...
            echo "Oops! Ha ocurrido un inconveniente y no hemos podido enviar su mensaje.";
        ...
        echo "Hubo un problema con su envio, por favor intente otra vez.";
